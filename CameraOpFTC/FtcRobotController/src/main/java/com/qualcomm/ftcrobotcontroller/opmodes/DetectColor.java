...
/*            int pixel = rgbImage.getPixel(width/2, height/2);
            int redValue0 = red(pixel);
            int blueValue0 = blue(pixel);
            int greenValue0 = green(pixel);
            telemetry.addData("0 Color:", String.format("Color: %d, %d, %d -- %d - %d - %d", redValue0, greenValue0, blueValue0, pixel, width, height));*/
            ...
            telemetry.addData("Color:", String.format("Color detected is: %s - %d, %d, %d", colorString, redValue, blueValue, greenValue));
